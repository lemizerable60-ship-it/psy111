...
// --- ICONS ---
const HomeIcon = () => e('svg', { xmlns: "http://www.w3.org/2000/svg", className: "h-6 w-6", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, e('path', { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" }));
const UsersIcon = () => e('svg', { xmlns: "http://www.w3.org/2000/svg", className: "h-6 w-6", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, e('path', { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M15 21a6 6 0 00-9-5.197M15 21a6 6 0 00-9-5.197" }));
const SettingsIcon = () => e('svg', { xmlns: "http://www.w3.org/2000/svg", className: "h-6 w-6", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, e('path', { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" }), e('path', { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M15 12a3 3 0 11-6 0 3 3 0 016 0z" }));
const PlusIcon = () => e('svg', { xmlns: "http://www.w3.org/2000/svg", className: "h-6 w-6", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, e('path', { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M12 6v6m0 0v6m0-6h6m-6 0H6" }));
const ChevronLeftIcon = () => e('svg', { xmlns: "http://www.w3.org/2000/svg", className: "h-6 w-6", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, e('path', { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M15 19l-7-7 7-7" }));
const SaveIcon = () => e('svg', { xmlns: "http://www.w3.org/2000/svg", className: "h-5 w-5 mr-2", viewBox: "0 0 20 20", fill: "currentColor" }, e('path', { d: "M8 2a2 2 0 00-2 2v12a2 2 0 002 2h4a2 2 0 002-2V4a2 2 0 00-2-2H8z" }), e('path', { d: "M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" }));
...
const TESTS = {
    ...
    hads: {
        ...
        questions: [
            { text: "Я испытываю напряжение, мне не по себе", options: ["Все время", "Часто", "Время от времени", "Совсем не испытываю"], points: [3, 2, 1, 0] },
            { text: "То, что приносило мне большое удовольствие, и сейчас вызывает у меня такое же чувство", options: ["Определенно, это так", "Наверное, это так", "Лишь в очень малой степени, это так", "Практически нет"], points: [0, 1, 2, 3] },
            { text: "Я испытываю страх, кажется, что что-то ужасное может вот-вот случиться", options: ["Определенно это так, и страх очень велик", "Да, это так, но страх не очень велик", "Иногда, но это меня не беспокоит", "Совсем не испытываю"], points: [3, 2, 1, 0] },
            { text: "Я способен рассмеяться и увидеть в том или ином событии смешное", options: ["Определенно, это так", "Наверное, это так", "Лишь в очень малой степени, это так", "Совсем не способен"], points: [0, 1, 2, 3] },
            { text: "Беспокойные мысли крутятся у меня в голове", options: ["Постоянно", "Большую часть времени", "Время от времени", "Только иногда"], points: [3, 2, 1, 0] },
            { text: "Я испытываю бодрость", options: ["Совсем не испытываю", "Очень редко", "Иногда", "Практически все время"], points: [3, 2, 1, 0] },
            { text: "Я легко могу присесть и расслабиться", options: ["Определенно, это так", "Наверное, это так", "Лишь изредка, это так", "Совсем не могу"], points: [0, 1, 2, 3] },
            { text: "Я стал медлительным", options: ["Практически все время", "Часто", "Иногда", "Совсем нет"], points: [3, 2, 1, 0] },
            { text: "Я испытываю внутреннее напряжение или дрожь", options: ["Совсем не испытываю", "Иногда", "Часто", "Очень часто"], points: [0, 1, 2, 3] },
            { text: "Я стал следить за своей внешностью", options: ["Я слежу за собой как следует", "Может быть, я не так много трачу на это времени", "Возможно, я стал меньше на это обращать внимания", "Определенно, я перестал за собой следить"], points: [0, 1, 2, 3] },
            { text: "Я не могу усидеть на месте, словно мне постоянно нужно двигаться", options: ["Определенно, это так", "Наверное, это так", "Лишь в некоторой степени, это так", "Вовсе нет"], points: [3, 2, 1, 0] },
            { text: "Я считаю, что мои дела (занятия, увлечения) могут принести мне чувство удовлетворения", options: ["Точно так же, как и обычно", "Пожалуй, меньше, чем обычно", "Значительно меньше, чем обычно", "Совсем так не считаю"], points: [0, 1, 2, 3] },
            { text: "У меня бывает внезапное чувство паники", options: ["Очень часто", "Довольно часто", "Не так уж часто", "Совсем не бывает"], points: [3, 2, 1, 0] },
            { text: "Я могу получить удовольствие от хорошей книги, радио- или телепрограммы", options: ["Часто", "Иногда", "Редко", "Очень редко"], points: [0, 1, 2, 3] },
        ],
        calculate: (answers) => {
    ...
    zung: {
        ...
        questions: [
            ...
            { text: "Утром я чувствую себя лучше всего", options: ["Никогда или редко", "Иногда", "Часто", "Постоянно или почти постоянно"], points: [4, 3, 2, 1] },
            ...
            { text: "Аппетит у меня не хуже, чем обычно", options: ["Никогда или редко", "Иногда", "Часто", "Постоянно или почти постоянно"], points: [4, 3, 2, 1] },
            { text: "Мне приятно смотреть на привлекательных женщин/мужчин, разговаривать с ними", options: ["Никогда или редко", "Иногда", "Часто", "Постоянно или почти постоянно"], points: [4, 3, 2, 1] },
            ...
            { text: "Я мыслю так же ясно, как всегда", options: ["Никогда или редко", "Иногда", "Часто", "Постоянно или почти постоянно"], points: [4, 3, 2, 1] },
            { text: "Мне легко делать то, что я умею", options: ["Никогда или редко", "Иногда", "Часто", "Постоянно или почти постоянно"], points: [4, 3, 2, 1] },
            ...
            { text: "У меня есть надежды на будущее", options: ["Никогда или редко", "Иногда", "Часто", "Постоянно или почти постоянно"], points: [4, 3, 2, 1] },
            ...
            { text: "Мне легко принимать решения", options: ["Никогда или редко", "Иногда", "Часто", "Постоянно или почти постоянно"], points: [4, 3, 2, 1] },
            { text: "Я чувствую, что полезен и нужен", options: ["Никогда или редко", "Иногда", "Часто", "Постоянно или почти постоянно"], points: [4, 3, 2, 1] },
            { text: "Я живу достаточно полной жизнью", options: ["Никогда или редко", "Иногда", "Часто", "Постоянно или почти постоянно"], points: [4, 3, 2, 1] },
            ...
            { text: "Меня до сих пор радует то, что радовало всегда", options: ["Никогда или редко", "Иногда", "Часто", "Постоянно или почти постоянно"], points: [4, 3, 2, 1] },
        ],
        calculate: (answers) => {
            const total = answers.reduce((sum, val) => sum + val, 0);
            return { total };
...
const Card = ({ children, className, onClick }) => {
  return e('div', { onClick, className: `bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 ${className || ''}` }, children);
};

const Button = ({ onClick, children, className, type = 'button', disabled }) => {
  return e('button', { type, onClick, disabled, className: `bg-primary-600 text-white font-semibold px-4 py-2 rounded-lg hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-opacity-50 transition-colors duration-200 ${className || ''} ${disabled ? 'opacity-50 cursor-not-allowed' : ''}` }, children);
};

const AppHeader = ({ title, onBack }) => {
  return e('header', { className: "bg-white dark:bg-gray-800 shadow-sm p-4 flex items-center" },
    onBack && e('button', { onClick: onBack, className: "mr-4 text-gray-600 dark:text-gray-300 hover:text-primary-600" }, e(ChevronLeftIcon)),
    e('h1', { className: "text-xl font-bold text-gray-800 dark:text-gray-200" }, title)
  );
};
...
const HomeScreen = ({ setScreen }) => {
  return e('div', null,
    e(AppHeader, { title: "PsychoSuite" }),
    e('main', { className: "p-4 grid grid-cols-1 md:grid-cols-2 gap-4" },
      e(Card, { className: "cursor-pointer hover:shadow-lg transition-shadow", onClick: () => setScreen({ name: 'clientList' }) },
        e(UsersIcon),
        e('h2', { className: "text-lg font-bold mt-2" }, "Клиенты"),
        e('p', { className: "text-gray-600 dark:text-gray-400" }, "Просмотр и управление базой клиентов")
      ),
      e(Card, { className: "cursor-pointer hover:shadow-lg transition-shadow", onClick: () => setScreen({ name: 'settings' }) },
        e(SettingsIcon),
        e('h2', { className: "text-lg font-bold mt-2" }, "Настройки"),
        e('p', { className: "text-gray-600 dark:text-gray-400" }, "Импорт и экспорт данных")
      )
    )
  );
};
...
const ClientListScreen = ({ clients, setScreen }) => {
  return e('div', null,
    e(AppHeader, { title: "Список клиентов", onBack: () => setScreen({ name: 'home' }) }),
    e('main', { className: "p-4" },
      e(Button, { onClick: () => setScreen({ name: 'clientForm', clientId: null }), className: "mb-4 flex items-center" },
        e(PlusIcon, { className: "mr-2" }), "Добавить клиента"
      ),
      e('div', { className: "space-y-2" },
        clients.length > 0 ? clients.map(client =>
          e(Card, {
            ...
            e('h3', { className: "font-bold text-lg" }, client.name),
            e('p', { className: "text-sm text-gray-500" }, `Дата рождения: ${formatDate(client.birthDate)}`)
          )
        ) : e('p', null, "Список клиентов пуст.")
      )
    )
  );
};

const ClientForm = ({ clients, setClients, setScreen, clientId }) => {
  ...
  return e('div', null,
    e(AppHeader, { title: client ? "Редактировать клиента" : "Новый клиент", onBack: () => setScreen({ name: 'clientList' }) }),
    e('main', { className: "p-4" },
      e('form', { onSubmit: handleSubmit, className: "space-y-4" },
        e('div', null,
          e('label', { htmlFor: 'name', className: "block text-sm font-medium text-gray-700 dark:text-gray-300" }, "ФИО"),
          e('input', {
        ...
        e('div', null,
          e('label', { htmlFor: 'birthDate', className: "block text-sm font-medium text-gray-700 dark:text-gray-300" }, "Дата рождения"),
          e('input', {
...
const ClientDetailScreen = ({ setScreen, clientId, clients, testResults, reports }) => {
    ...
    if (!client) {
        return e('div', null, 'Клиент не найден.');
    }

    return e('div', null,
        e(AppHeader, { title: client.name, onBack: () => setScreen({ name: 'clientList' }) }),
        e('main', { className: "p-4 space-y-6" },
            e(Card, null,
                e('h2', { className: "text-lg font-bold mb-2" }, "Информация о клиенте"),
                e('p', null, `Дата рождения: ${formatDate(client.birthDate)}`),
                e(Button, { onClick: () => setScreen({ name: 'clientForm', clientId: client.id }), className: "mt-4 text-sm" }, "Редактировать")
            ),
            e(Card, null,
                e('h2', { className: "text-lg font-bold mb-2" }, "Начать новое обследование"),
                e('div', { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2" },
             ...
             e(Card, null,
                e('h2', { className: "text-lg font-bold mb-4" }, "История обследований"),
                e('div', { className: "space-y-2" },
                    clientTestResults.length > 0 ? clientTestResults.map(tr =>
                        e('div', {
                            ...
                            e('p', { className: "font-semibold" }, TESTS[tr.testKey].name),
                            e('p', { className: "text-sm text-gray-500" }, `Дата: ${formatDate(tr.date)}`)
                        )
                    ) : e('p', null, "Нет пройденных тестов.")
                )
            ),
             e(Card, null,
                e('h2', { className: "text-lg font-bold mb-4" }, "Сводные отчеты"),
                e(Button, { onClick: () => setScreen({ name: 'report', clientId: client.id }), className: "mb-4" }, "Создать новый сводный отчет"),
                 e('div', { className: "space-y-2" },
                    clientReports.length > 0 ? clientReports.map(report =>
                        e('div', {
                            ...
                            e('p', { className: "font-semibold" }, `Отчет от ${formatDate(report.date)}`),
                            e('p', { className: "text-sm text-gray-500" }, `Тестов в отчете: ${report.testResultIds.length}`)
                        )
                    ) : e('p', null, "Нет сохраненных отчетов.")
                )
            )
        )
    );
...
const TestScreen = ({ setScreen, clientId, testKey, testResults, setTestResults }) => {
  ...
  return e('div', null,
    e(AppHeader, { title: test.name, onBack: () => setScreen({ name: 'clientDetail', clientId }) }),
    e('main', { className: "p-4" },
      e('div', { className: "space-y-6" },
        test.questions.map((q, qIndex) =>
          e(Card, { key: qIndex },
            e('p', { className: "font-semibold mb-3" }, `${qIndex + 1}. ${q.text}`),
        ...
        e(Button, { onClick: handleSubmit, disabled: !isComplete }, "Завершить тест и посмотреть результаты")
      )
    )
  );
};
...
const TestResultScreen = ({ setScreen, resultId, clients, testResults, setTestResults }) => {
    ...
    if (!result) {
        return e('div', null, 'Результат теста не найден.');
    }
    ...
    return e('div', null,
        e(AppHeader, { title: "Результаты теста", onBack: () => setScreen({ name: 'clientDetail', clientId: result.clientId }) }),
        e('main', { className: "p-4 space-y-6" },
            e('div', { className: "flex justify-end" },
                e(Button, { onClick: generateTxtReport, className: "flex items-center" }, e(SaveIcon), "Сохранить протокол (.txt)")
            ),
            e(Card, null,
                e('h2', { className: "text-lg font-bold mb-4" }, "Протокол обследования"),
                e('div', { className: "grid grid-cols-2 gap-4 mb-6" },
                    e('div', null, e('p', {className: "text-sm text-gray-500"}, "Клиент"), e('p', {className: "font-semibold"}, client?.name)),
                    e('div', null, e('p', {className: "text-sm text-gray-500"}, "Дата рождения"), e('p', {className: "font-semibold"}, formatDate(client?.birthDate || ''))),
                    e('div', null, e('p', {className: "text-sm text-gray-500"}, "Тест"), e('p', {className: "font-semibold"}, test.name)),
                    e('div', null, e('p', {className: "text-sm text-gray-500"}, "Дата проведения"), e('p', {className: "font-semibold"}, formatDate(result.date)))
                ),
                e('h3', { className: "text-md font-bold mb-2 border-t pt-4" }, "Итоговые результаты"),
                 e('div', { className: "flex items-start gap-8" },
                    e('div', { className: "flex gap-4" },
                      Object.entries(result.scores).map(([key, value]) =>
                          e('div', { key: key, className: "text-center" },
                              e('p', { className: "text-3xl font-bold text-primary-600" }, value),
                              e('p', { className: "text-sm text-gray-500" }, key)
                          )
                      )
                    ),
                    e('div', null,
                        e('h4', { className: "font-semibold mb-1" }, "Стандартная интерпретация:"),
                        e('ul', { className: "list-disc list-inside space-y-1" },
                            Object.values(result.interpretation).map((inter, index) => e('li', { key: index }, inter))
                        )
                    )
                )
            ),
...
const ReportScreen = ({ setScreen, clientId, reportId, clients, testResults, reports, setReports }) => {
    const client = clients.find(c => c.id === clientId);
    const clientTestResults = testResults.filter(tr => tr.clientId === clientId);
    ...
    if (!client) return e('div', null, 'Клиент не найден.');

    const selectedResults = clientTestResults.filter(tr => selectedTestIds.has(tr.id));

    return e('div', null,
        e(AppHeader, { title: "Сводный отчет", onBack: () => setScreen({ name: 'clientDetail', clientId }) }),
        e('main', { className: "p-4 grid grid-cols-1 lg:grid-cols-3 gap-6" },
            e('div', { className: "lg:col-span-1 space-y-4" },
                e(Card, null,
                   e('h3', { className: "font-bold mb-2" }, "1. Выберите тесты"),
                   e('div', { className: "space-y-2 max-h-60 overflow-y-auto" },
                        clientTestResults.map(tr =>
                            e('div', {
                                ...
                                e('p', {className: "font-semibold"}, TESTS[tr.testKey].name),
                                e('p', {className: "text-sm"}, formatDate(tr.date))
                           )
                        )
                   )
                ),
                 e(Card, null,
                   e('h3', { className: "font-bold mb-2" }, "2. Сгенерируйте анализ (AI)"),
                    e(Button, { onClick: generateConsolidatedReport, disabled: isLoading || selectedTestIds.size === 0 || !aiService.isAvailable() }, isLoading ? "Генерация..." : "Создать/обновить сводный анализ"),
                     !aiService.isAvailable() && e('p', { className: "text-xs text-yellow-600 mt-2" }, "Сервис AI недоступен.")
                ),
                e(Card, null,
                   e('h3', { className: "font-bold mb-2" }, "Сохраненные сводные отчеты"),
                   e('div', { className: "space-y-2 max-h-60 overflow-y-auto" },
                        ...
                        ) : e('p', {className: "text-sm"}, "Нет отчетов.")
                   )
                )
            ),
             e('div', { className: "lg:col-span-2 space-y-4" },
                e('div', {className: "flex justify-end"},
                    e(Button, { onClick: generateTxtReport, disabled: selectedTestIds.size === 0, className: "flex items-center" }, e(SaveIcon), "Сохранить отчет (.txt)")
                ),
                e(Card, null,
                   e('h3', { className: "font-bold mb-2" }, "Краткая сводка по выбранным тестам"),
                   selectedResults.length > 0 ? e('ul', { className: "space-y-2" },
                       selectedResults.map(tr =>
                           e('li', { key: tr.id },
                               e('strong', null, TESTS[tr.testKey].name),
                               e('span', { className: "text-sm text-gray-500" }, ` (${formatDate(tr.date)})`),
                               e('p', { className: "text-sm pl-2" }, `Баллы: ${JSON.stringify(tr.scores)}`),
                               e('p', { className: "text-sm pl-2" }, `Интерпретация: ${Object.values(tr.interpretation).join(' ')}`)
                           )
                       )
                   ) : e('p', null, "Выберите тесты для отображения сводки.")
                ),
                 e(Card, null,
                   e('h3', { className: "font-bold mb-2" }, "Сводный анализ (AI)"),
                    consolidatedReport ? e('div', { className: "whitespace-pre-wrap p-2 bg-gray-50 dark:bg-gray-700 rounded" }, consolidatedReport) : e('p', null, "Сгенерируйте анализ для просмотра.")
                )
             )
        )
    );
...
const SettingsScreen = ({ setScreen, setData }) => {
    ...
    return e('div', null,
        e(AppHeader, { title: "Настройки", onBack: () => setScreen({ name: 'home' }) }),
        e('main', { className: "p-4 space-y-4" },
            e(Card, null,
                e('h2', { className: "text-lg font-bold mb-2" }, "Экспорт данных"),
                e('p', { className: "text-gray-600 dark:text-gray-400 mb-4" }, "Сохранить всю базу клиентов и результатов в один JSON-файл."),
                e(Button, { onClick: handleExport }, "Экспортировать")
            ),
            e(Card, null,
                e('h2', { className: "text-lg font-bold mb-2" }, "Импорт данных"),
                e('p', { className: "text-gray-600 dark:text-gray-400 mb-4" }, "Загрузить данные из ранее экспортированного JSON-файла. Внимание: это перезапишет все текущие данные!"),
                e('input', { type: 'file', accept: '.json', onChange: handleImport, className: "hidden", ref: importRef }),
                e(Button, { onClick: () => importRef.current?.click() }, "Импортировать")
            )
        )
    );
};
...
// --- MAIN APP COMPONENT ---
const App = () => {
  const [screen, setScreen] = useStickyState({ name: 'home' }, 'screen');
  const [clients, setClients] = useStickyState([], 'clients');
  const [testResults, setTestResults] = useStickyState([], 'testResults');
  const [reports, setReports] = useStickyState([], 'reports');
  ...
  const renderScreen = () => {
    switch (screen.name) {
      case 'home':
        return e(HomeScreen, { setScreen });
      case 'clientList':
        return e(ClientListScreen, { clients, setScreen });
      case 'clientForm':
        return e(ClientForm, { clients, setClients, setScreen, clientId: screen.clientId });
      case 'clientDetail':
        return e(ClientDetailScreen, { setScreen, clientId: screen.clientId, clients, testResults, reports });
      case 'test':
        return e(TestScreen, { setScreen, clientId: screen.clientId, testKey: screen.testKey, testResults, setTestResults });
      case 'testResult':
        return e(TestResultScreen, { setScreen, resultId: screen.resultId, clients, testResults, setTestResults });
      case 'report':
        return e(ReportScreen, { setScreen, clientId: screen.clientId, reportId: screen.reportId, clients, testResults, reports, setReports });
      case 'settings':
        return e(SettingsScreen, { setScreen, setData });
      default:
        return e(HomeScreen, { setScreen });
    }
  };

  return e('div', { className: "min-h-screen bg-gray-100 dark:bg-gray-900" }, renderScreen());
};
